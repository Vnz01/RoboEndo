#!/usr/bin/python3
# Last Edited: 06Mar2023 by Alexander Luke
...
CALIBRATION_ID = '07Apr2023'                # date of calibration file to be saved/read
...
class CatheterController():
    ...
    def tensioningSequence(self):
        ...
        if EXISTING_CALIBRATION == 1:
            cali_file_name = 'Calibration_'+CALIBRATION_ID+'_'+CATHETER_ID+'.npy'
            cali_zero_angles = np.load('/home/arclab/'+cali_file_name)
            ...
            for j in range(num_tension_attempts):
                ...
                for i in range(0,MOTOR_NUM):
                    ...
                    attempt_starting_angle = target_position[i]
                    print("      Tensioning Spool "+str(i+1)+" ... Start: "+str(attempt_starting_angle))
                    ...
                    while(True):
                        ...
                        if(a=='w'):
                            ...
                            delta = target_position[i]-attempt_starting_angle
            ...
            cali_file_name = 'Calibration_'+CALIBRATION_ID+'_'+CATHETER_ID
            np.save(cali_file_name,cali_zero_angles)
            print(' ')
            print('The calibration has been saved as '+cali_file_name+'.npy')
