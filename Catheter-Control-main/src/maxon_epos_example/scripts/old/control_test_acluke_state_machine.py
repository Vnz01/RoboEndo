...
CALIBRATION_ID = '01May2023_MP12'            # date of calibration file to be saved/read
...
if __name__ == "__main__": 
    ...
    try: # Start Control Loop
        ...
        while not rospy.is_shutdown():
            ...
            x_rotated_circle = max_tip_angle*(x*np.cos(offset_theta) - y*np.sin(offset_theta))
            y_rotated_circle = max_tip_angle*(x*np.sin(offset_theta) + y*np.cos(offset_theta))
